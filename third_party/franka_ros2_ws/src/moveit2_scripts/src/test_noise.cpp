...
// static const rclcpp::Logger LOGGER = rclcpp::get_logger("three_pose_loop");

// int main(int argc, char **argv) {
//   rclcpp::init(argc, argv);
//   auto node = rclcpp::Node::make_shared("three_pose_loop_node");
...
//   postplace_pose.position.x = 0.306379;
//   postplace_pose.position.y = 0.001056;
//   postplace_pose.position.z = 0.589668;
//   postplace_pose.orientation.x = 0.999973;
//   postplace_pose.orientation.y = 0.006091;
//   postplace_pose.orientation.z = -0.003571;
//   postplace_pose.orientation.w = -0.002196;

//   std::vector<std::pair<std::string, geometry_msgs::msg::Pose>> three_pose_sequence = {
//     {"prepick", prepick_pose},
//     {"postpick", postpick_pose},
//     {"postplace", postplace_pose}
//   };

//   // Run the sequence 3 times
//   for (int cycle = 0; cycle < 3; ++cycle) {
//     RCLCPP_INFO(LOGGER, "=== Starting cycle %d ===", cycle + 1);

//     for (const auto& [label, pose] : three_pose_sequence) {
...
//       // Close gripper at "prepick"
//       if (label == "prepick") {
//         move_group_gripper.setJointValueTarget(gripper_close);
//         if (move_group_gripper.move() == moveit::core::MoveItErrorCode::SUCCESS) {
//           RCLCPP_INFO(LOGGER, "Gripper closed at prepick.");
//         } else {
//           RCLCPP_ERROR(LOGGER, "Failed to close gripper at prepick.");
//         }
//       }
//     }
//   }

//   RCLCPP_INFO(LOGGER, "=== Finished 3-cycle loop ===");
//   rclcpp::shutdown();
//   return 0;
// }
...
int main(int argc, char **argv) {
  ...
  pick_pose.position.x = 0.81375;
  pick_pose.position.y = -0.126065;
  pick_pose.position.z = 0.42;  // Was 0.420 + 0.01; now set directly
  ...
  clearance_pose.position.z = 0.551070;
  ...
  preplace_pose.position.x = 0.632638;
  preplace_pose.position.y = -0.030421;
  preplace_pose.position.z = 0.557839;
  preplace_pose.orientation.x = 0.966369;
  preplace_pose.orientation.y = -0.033580;
  preplace_pose.orientation.z = 0.254224;
  preplace_pose.orientation.w = 0.019299;
 ...
 geometry_msgs::msg::Pose place_pose;
  ...
  place_pose.position.x = 0.525221;
  place_pose.position.y = -0.080129;
  place_pose.position.z = 0.568463;
  place_pose.orientation.x = 0.962745;
  place_pose.orientation.y = -0.053745;
  place_pose.orientation.z = 0.262573;
  place_pose.orientation.w = 0.035896;

  geometry_msgs::msg::Pose postplace_pose;
  postplace_pose.position.x = 0.526622;
  postplace_pose.position.y = 0.017014;
  postplace_pose.position.z = 0.571420;
